...
export const projects: Project[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "the-outcome", title: "solution", heading: "Flow 1: Memory Box", content: "The hardest part for users is not the organizing process itself, but having to take action before they are emotionally ready. " },
