...
export const projects: Project[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "solution-2", title: "SOLUTION", heading: "2. Return to it later", content: "Later, in Sober Review, users can revisit what they wrote with more distance and better judgment. They can send the message as-is, revise it with clearer intent, or simply let the moment pass—turning reaction into reflection." },
      { id: "solution-3", title: "SOLUTION", heading: "3. Understand what was underneath", content: "Beyond storing the message, The Jar also helps users reflect on what may have been driving it. Through Underneath, AI-generated prompts surface possible emotions, motivations, and tensions behind the text—not to define the truth for the user, but to support a more honest review later." },
